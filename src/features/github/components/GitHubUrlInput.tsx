...
export function GitHubUrlInput({
  ...
  return (
    <div className="space-y-2">
      <label htmlFor="github-url" className="flex items-center text-sm font-medium text-content">
        Repository URL
        <button
          type="button"
        ...
        <div className="relative flex-1">
          ...
          {url && (
            <button
              ...
              className="absolute right-2 top-2.5 h-5 w-5 rounded flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-200 dark:text-gray-500 dark:hover:text-gray-300 dark:hover:bg-gray-700 transition-colors"
