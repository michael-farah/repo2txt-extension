...
function getFileIcon(filename: string, isSelected: boolean) {
  ...
  if (ext === 'ts' || ext === 'tsx') {
    return (
      <svg className={cn('w-4 h-4', isSelected ? 'text-blue-500' : 'text-blue-400')} viewBox="0 0 16 16" fill="currentColor">
  ...
  if (ext === 'js' || ext === 'jsx' || ext === 'mjs' || ext === 'cjs') {
    return (
      <svg className={cn('w-4 h-4', isSelected ? 'text-yellow-500' : 'text-yellow-400')} viewBox="0 0 16 16" fill="currentColor">
  ...
  if (ext === 'py' || ext === 'pyi' || ext === 'pyw') {
    return (
      <svg className={cn('w-4 h-4', isSelected ? 'text-sky-500' : 'text-sky-400')} viewBox="0 0 16 16" fill="currentColor">
  ...
  if (ext === 'rs') {
    return (
      <svg className={cn('w-4 h-4', isSelected ? 'text-orange-500' : 'text-orange-400')} viewBox="0 0 16 16" fill="currentColor">
  ...
  if (ext === 'css' || ext === 'scss' || ext === 'less' || ext === 'sass') {
    return (
      <svg className={cn('w-4 h-4', isSelected ? 'text-purple-500' : 'text-purple-400')} viewBox="0 0 16 16" fill="currentColor">
  ...
  if (ext === 'json' || ext === 'jsonc' || ext === 'json5') {
    return (
      <svg className={cn('w-4 h-4', isSelected ? 'text-green-500' : 'text-green-400')} viewBox="0 0 16 16" fill="currentColor">
  ...
  if (ext === 'md' || ext === 'mdx') {
    return (
      <svg className={cn('w-4 h-4', isSelected ? 'text-gray-600 dark:text-gray-300' : 'text-gray-400 dark:text-gray-500')} viewBox="0 0 16 16" fill="currentColor">
  ...
  if (ext === 'png' || ext === 'jpg' || ext === 'jpeg' || ext === 'gif' || ext === 'svg' || ext === 'webp' || ext === 'ico') {
    return (
      <svg className={cn('w-4 h-4', isSelected ? 'text-emerald-500' : 'text-emerald-400')} viewBox="0 0 16 16" fill="currentColor">
  ...
  // Config files
  if (ext === 'yml' || ext === 'yaml' || ext === 'toml' || ext === 'env' || ext === 'ini' || ext === 'cfg' || ext === 'conf') {
    return (
      <svg className={cn('w-4 h-4', isSelected ? 'text-amber-500' : 'text-amber-400')} viewBox="0 0 16 16" fill="currentColor">
  ...
  if (ext === 'sh' || ext === 'bash' || ext === 'zsh' || ext === 'fish') {
    return (
      <svg className={cn('w-4 h-4', isSelected ? 'text-lime-500' : 'text-lime-400')} viewBox="0 0 16 16" fill="currentColor">
  ...
  if (ext === 'go') {
    return (
      <svg className={cn('w-4 h-4', isSelected ? 'text-cyan-500' : 'text-cyan-400')} viewBox="0 0 16 16" fill="currentColor">
...
function getDirectoryIcon(isOpen: boolean) {
  return (
    <svg
      className={cn('w-4 h-4', isOpen ? 'text-primary-500' : 'text-primary-400 dark:text-primary-500')}
      fill="currentColor"
      viewBox="0 0 20 20"
    >
      {isOpen ? (
    ...
    >
      ...
      {!isExcluded && (
        <input
          ...
          className="flex-shrink-0 h-4 w-4 rounded border-stroke text-primary-600 focus:ring-primary-500 focus:ring-offset-0 dark:bg-gray-800"
      ...
      <div className="flex-shrink-0">
        {isDirectory ? getDirectoryIcon(isOpen) : getFileIcon(node.name, checkboxState === 'checked')}
      </div>
