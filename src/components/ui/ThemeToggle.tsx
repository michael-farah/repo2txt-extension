...
export function ThemeToggle() {
  ...
  const getIcon = () => {
    if (theme === 'light') {
      return (
        <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4 text-gray-600 dark:text-gray-400" data-testid="theme-icon">
          ...
          <line x1="3.5" y1="3.5" x2="5.3" y2="5.3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
          <line x1="14.7" y1="14.7" x2="16.5" y2="16.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
          <line x1="3.5" y1="16.5" x2="5.3" y2="14.7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
          <line x1="14.7" y1="5.3" x2="16.5" y2="3.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        </svg>
      );
    }
    if (theme === 'dark') {
